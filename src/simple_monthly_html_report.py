#!/usr/bin/env python3
"""
🎯 Simple Monthly HTML Report Generator
Creates a clean HTML report for the $10,000 monthly trading system
"""
...
def generate_simple_html_report(results: dict, filename: str = "monthly_trading_report.html"):
    """Generate a simple HTML report for monthly backtest results."""
    ...
    daily_profit = total_profit / 30 if total_profit else 0
    daily_return = total_return / 30 if total_return else 0
    daily_trades = total_trades / 30 if total_trades else 0
    annual_return = total_return * 12 if total_return else 0
    annual_profit = total_profit * 12 if total_profit else 0
                ...
                <div class="section">
                    ...
                    <table class="stats-table">
                        ...
                        <tr>
                            <td>Win Rate</td>
                            <td>{win_rate:.1%}</td>
                            <td>{'Strong success rate' if win_rate > 0.6 else 'Good success rate' if win_rate > 0.5 else 'Needs improvement'}</td>
                        </tr>
                        <tr>
                            <td>Profit Factor</td>
                        ...
                        <tr>
                            ...
                            <td>1:{risk_reward_ratio:.2f}</td>
                            <td>{'Good' if risk_reward_ratio > 1 else 'Needs improvement'}</td>
                        </tr>
                        <tr>
...
def main():
    """Generate simple monthly HTML report."""
    print("🎯 GENERATING SIMPLE MONTHLY HTML REPORT")
    print("=" * 50)
    ...
    filename = generate_simple_html_report(results)
